...
/usr/share/java/opencv4/opencv-$(shell echo '$(OPENCV_VERSION)' | tr -d '.').jar /usr/lib/libopencv_java$(shell echo '$(OPENCV_VERSION)' | tr -d '.').so: $(TARGET)/opencv/trunk/opencv-$(OPENCV_VERSION)-1-x86_64.pkg.tar.xz
	pacman \
		-U "$(TARGET)/opencv/trunk/opencv-$(OPENCV_VERSION)-1-x86_64.pkg.tar.xz" \
		--noconfirm
